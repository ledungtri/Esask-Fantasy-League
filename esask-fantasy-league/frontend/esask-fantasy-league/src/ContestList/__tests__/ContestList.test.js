...
const mockContestData = {
    "success":true,
    "data":[
        {"_id":"613d65ea63676a0636013920","name":"Contest number 1","startDate":"2021-09-12T00:00:00.000Z","endDate":"2021-09-19T00:00:00.000Z","status":"In progress","__v":0},
        {"_id":"614a95ba0ef0f364014b401c","name":"Contest number 2","startDate":"2021-09-21T06:00:00.000Z","endDate":"2021-09-27T00:00:00.000Z","status":"Finished","__v":0},
        {"_id":"614a95ee0ef0f364014b401d","name":"Contest number 3","startDate":"2021-09-28T00:00:00.000Z","endDate":"2021-10-05T00:00:00.000Z","status":"Upcoming","__v":0}
    ]
};
...
test('check if buttons are disabled for a closed contest and enabled for an open contest', async () => {
    const row1 = within((await screen.findAllByTestId("contest-row"))[0])
    expect(row1.getByRole("button")).toBeDisabled();
    const row3 = within((await screen.findAllByTestId("contest-row"))[2])
    expect(row3.getByRole("button")).toBeEnabled();
});